        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 text-white">
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start gap-3 mt-5">
              {[1,2].map(i => (
                <a key={i} href={i === 1 ? "https://www.instagram.com/table4.six/" : "#"} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 text-white hover:bg-white hover:text-black rounded-full flex items-center justify-center transition-colors duration-300">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mb-2 flex items-center justify-center md:justify-start gap-2 text-sm text-gray-300">
              ...
              <a href="mailto:hello@table4six.com" className="hover:text-white transition break-all">hello@table4six.com</a>
            </p>
